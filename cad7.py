...
#Iniciamos iteracción con el usuario
print("Bienvenido/a al Mastermind!")
print("Tienes que adivinar un numero de %d cifras distintas"%cant_digitos)
print("Aciertos=digitos atinados, Coincidencias=digitos atinados pero en otro orden")
propuesta=input("Que codigo propones?: ")
#procesamos las propuestas e indicamos aciertos y coincidencias
intentos=1
while propuesta != codigo and propuesta!="me rindo":
    intentos=intentos+1
    aciertos=0
    coincidencias=0
    ...
    for i in range(cant_digitos):
        if propuesta[i]==codigo[i]:
            ...
            coincidencias+=1
    print("Tu propuesta (%s) tiene %d aciertos" \
             "y %d coincidencias"%(propuesta,aciertos,coincidencias))
    #pedimos siguiente propuesta
    propuesta=input("Propon otro codigo o escribe me rindo: ")
